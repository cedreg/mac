...
class FaceView: UIView
{
    ...
    private var skullRadius : CGFloat {
        return ((bounds.size.width < bounds.size.height) ? bounds.size.width : bounds.size.height) / 2 * scale
    }
    ...
    // DRAW CIRCLE AROUND GIVEN POINT WITH RADIUS
    ...
    // DRAW FUNCTION CALLED BY THE SYSTEM
